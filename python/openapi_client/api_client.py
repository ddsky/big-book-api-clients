...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.find_similar_books  # this is an instance of the class Endpoint
        api_instance.find_similar_books()  # this invokes api_instance.find_similar_books.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.find_similar_books.callable or self.callable in this class
