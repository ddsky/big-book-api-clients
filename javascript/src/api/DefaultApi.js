...
export default class DefaultApi {
    ...
    */
     ...
     * @callback module:api/DefaultApi~findSimilarBooksCallback
     ...
     * @param {module:api/DefaultApi~findSimilarBooksCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/DefaultApi~getBookInformationCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/DefaultApi~getBookInformationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
     ...
     * @callback module:api/DefaultApi~searchAuthorsCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [name] The (partial/beginning) name of the author.
     * @param {Number} [offset] The number of authors to skip in range [0,100]
     * @param {Number} [number] The number of authors to return in range [1,100]
     * @param {module:api/DefaultApi~searchAuthorsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
     ...
     * @callback module:api/DefaultApi~searchBooksCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/DefaultApi~searchBooksCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
