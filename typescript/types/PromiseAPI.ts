...
export class PromiseDefaultApi {
     ...
     */
    public findSimilarBooksWithHttpInfo(id: number, number?: number, _options?: Configuration): Promise<HttpInfo<any>> {
     ...
     */
    public getBookInformationWithHttpInfo(id: number, _options?: Configuration): Promise<HttpInfo<any>> {
        const result = this.api.getBookInformationWithHttpInfo(id, _options);
        return result.toPromise();
    }
     ...
     */
    public searchAuthorsWithHttpInfo(name?: string, offset?: number, number?: number, _options?: Configuration): Promise<HttpInfo<any>> {
        const result = this.api.searchAuthorsWithHttpInfo(name, offset, number, _options);
        return result.toPromise();
    }
