...
namespace com.bigbookapi.client\com.bigbookapi;
...
use com.bigbookapi.client\HeaderSelector;
...
class DefaultApi
{
     ...
     *
     * @throws \com.bigbookapi.client\ApiException on non-2xx response
    ...
    {
        list($response) = $this->getBookInformationWithHttpInfo($id);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBookInformationWithHttpInfo($id)
    {
        $request = $this->getBookInformationRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBookInformationAsync($id)
    {
        return $this->getBookInformationAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBookInformationAsyncWithHttpInfo($id)
    {
        $returnType = 'object';
        $request = $this->getBookInformationRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBookInformationRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return object
     */
    public function searchAuthors($name = null, $offset = null, $number = null)
    {
        list($response) = $this->searchAuthorsWithHttpInfo($name, $offset, $number);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchAuthorsWithHttpInfo($name = null, $offset = null, $number = null)
    {
        $request = $this->searchAuthorsRequest($name, $offset, $number);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAuthorsAsync($name = null, $offset = null, $number = null)
    {
        return $this->searchAuthorsAsyncWithHttpInfo($name, $offset, $number)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAuthorsAsyncWithHttpInfo($name = null, $offset = null, $number = null)
    {
        $returnType = 'object';
        $request = $this->searchAuthorsRequest($name, $offset, $number);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchAuthorsRequest($name = null, $offset = null, $number = null)
    {
