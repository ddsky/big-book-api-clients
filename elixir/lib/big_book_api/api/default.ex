...
defmodule BigBookAPI.Api.Default do
  @moduledoc """
  API calls for all endpoints tagged `Default`.
  """

  alias BigBookAPI.Connection
  import BigBookAPI.RequestBuilder
  ...
  - `connection` (BigBookAPI.Connection): Connection to server
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:"earliest-publish-year"` (float()): The books must have been published after this year.
    - `:"latest-publish-year"` (float()): The books must have been published before this year.
