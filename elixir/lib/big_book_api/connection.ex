...
defmodule BigBookAPI.Connection do
  @moduledoc """
  Handle Tesla connections for BigBookAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, BigBookAPI.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:bigbookapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - BigBookAPI 1.0 - elixir"
        )
      )
