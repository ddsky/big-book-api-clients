...
import bigbookapi.infrastructure.ApiClient
import bigbookapi.infrastructure.ApiResponse
import bigbookapi.infrastructure.ClientException
import bigbookapi.infrastructure.ClientError
import bigbookapi.infrastructure.ServerException
import bigbookapi.infrastructure.ServerError
import bigbookapi.infrastructure.MultiValueMap
import bigbookapi.infrastructure.PartConfig
import bigbookapi.infrastructure.RequestConfig
import bigbookapi.infrastructure.RequestMethod
import bigbookapi.infrastructure.ResponseType
import bigbookapi.infrastructure.Success
import bigbookapi.infrastructure.toMultiValue
...
class DefaultApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun findSimilarBooks(id: java.math.BigDecimal, number: java.math.BigDecimal? = null) : kotlin.Any {
    ...
    fun findSimilarBooksRequestConfig(id: java.math.BigDecimal, number: java.math.BigDecimal?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/{id}/similar".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
    ...
    fun getBookInformationRequestConfig(id: java.math.BigDecimal) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/{id}".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun searchAuthors(name: kotlin.String? = null, offset: java.math.BigDecimal? = null, number: java.math.BigDecimal? = null) : kotlin.Any {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun searchBooks(query: kotlin.String? = null, earliestPublishYear: java.math.BigDecimal? = null, latestPublishYear: java.math.BigDecimal? = null, minRating: java.math.BigDecimal? = null, maxRating: java.math.BigDecimal? = null, genres: kotlin.String? = null, authors: kotlin.String? = null, isbn: kotlin.String? = null, oclc: kotlin.String? = null, sort: kotlin.String? = null, sortDirection: kotlin.String? = null, groupResults: kotlin.Boolean? = null, offset: java.math.BigDecimal? = null, number: java.math.BigDecimal? = null) : kotlin.Any {
