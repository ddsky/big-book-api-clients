## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Big Book API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Big Book API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | BigBook                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | big-book                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | BigBookConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | BigBookRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| BigBook.Client    | use the "dispatch" functions to send requests       |
| BigBook.Core      | core functions, config and request types            |
| BigBook.API       | construct api requests                              |
| BigBook.Model     | describes api models                                |
| BigBook.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| BigBook.ModelLens | lenses for model fields                             |
| BigBook.Logging   | logging functions and utils                         |
