...
-- |
data BigBookConfig = BigBookConfig
...
-- | display the config
instance P.Show BigBookConfig where
  show c =
    T.printf
...
-- | constructs a default BigBookConfig
--
-- configHost:
--
...
-- @"big-book/0.1.0.0"@
--
newConfig :: IO BigBookConfig
newConfig = do
    logCxt <- initLogContext
    return $ BigBookConfig
        { configHost = "https://api.bigbookapi.com"
        , configUserAgent = "big-book/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => BigBookConfig -> auth -> BigBookConfig
addAuthMethod config@BigBookConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: BigBookConfig -> IO BigBookConfig
...
withStderrLogging :: BigBookConfig -> IO BigBookConfig
...
withNoLogging :: BigBookConfig -> BigBookConfig
...
data BigBookRequest req contentType res accept = BigBookRequest
  { rMethod  :: NH.Method   -- ^ Method of BigBookRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of BigBookRequest
  , rParams   :: Params -- ^ params of BigBookRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (BigBookRequest req contentType res accept) NH.Method
rMethodL f BigBookRequest{..} = (\rMethod -> BigBookRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (BigBookRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f BigBookRequest{..} = (\rUrlPath -> BigBookRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (BigBookRequest req contentType res accept) Params
rParamsL f BigBookRequest{..} = (\rParams -> BigBookRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (BigBookRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f BigBookRequest{..} = (\rAuthTypes -> BigBookRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => BigBookRequest req contentType res accept -> param -> BigBookRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: BigBookRequest req contentType res accept -> param -> BigBookRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: BigBookRequest req contentType res accept -> param -> BigBookRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** BigBookRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> BigBookRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = BigBookRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     BigBookRequest req contentType res accept
  -> [NH.Header]
  -> BigBookRequest req contentType res accept
...
removeHeader :: BigBookRequest req contentType res accept -> [NH.HeaderName] -> BigBookRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => BigBookRequest req contentType res accept -> BigBookRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => BigBookRequest req contentType res accept -> BigBookRequest req contentType res accept
...
addForm :: BigBookRequest req contentType res accept -> WH.Form -> BigBookRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: BigBookRequest req contentType res accept -> NH.Part -> BigBookRequest req contentType res accept
...
_setBodyBS :: BigBookRequest req contentType res accept -> B.ByteString -> BigBookRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: BigBookRequest req contentType res accept -> BL.ByteString -> BigBookRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => BigBookRequest req contentType res accept -> P.Proxy authMethod -> BigBookRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> BigBookRequest req contentType res accept
    -> IO (BigBookRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> BigBookConfig
  -> IO (BigBookRequest req contentType res accept)
_applyAuthMethods req config@(BigBookConfig {configAuthMethods = as}) =
  foldlM go req as
  where
